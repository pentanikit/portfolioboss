...
<head>
  ...
  <style>
    ...
    input{width:90%;padding:10px;border-radius:10px;border:1px solid #1f2937;background:#0b0f15;color:#e5e7eb;}
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    btn.addEventListener('click', () => {
      ...
      // swap icons
      eyeOn.hidden  = !showing;  // show eye when hidden
      eyeOff.hidden = showing;   // show eye-off when visible
    });
  });
</script>
